...
sequenceDiagram
    ...
    You->>Waiter: I'd like to place an order (HTTP Request)
    Waiter->>Kitchen: Prepare the order
    Kitchen-->>Waiter: Here is the order (Data)
    Waiter-->>You: Your order is served (HTTP Response)
```
...
user --> frontend : Uses Website
frontend -> express : HTTP API Calls (GET, POST, etc.)
express --> frontend : HTTP Responses (HTML, JSON)
express -right-> db : Reads/Writes Data
@enduml
```
...
## [](https://dev.to/_boweii/choosing-a-stack-is-a-social-decision-not-a-technical-one-o60#the-myth-of-the-best-stack)The Myth of the “Best Stack”
...
## [](https://dev.to/_boweii/choosing-a-stack-is-a-social-decision-not-a-technical-one-o60#stack-choices-are-about-who-you-can-hire)Stack Choices Are About Who You Can Hire
...
## [](https://dev.to/_boweii/choosing-a-stack-is-a-social-decision-not-a-technical-one-o60#familiarity-beats-excellence-every-time)Familiarity Beats Excellence Every Time
...
## [](https://dev.to/_boweii/choosing-a-stack-is-a-social-decision-not-a-technical-one-o60#tech-stack-decisions-are-political-yes-political)Tech Stack Decisions Are Political (Yes, Political)
...
## [](https://dev.to/_boweii/choosing-a-stack-is-a-social-decision-not-a-technical-one-o60#modern-often-means-socially-accepted)“Modern” Often Means “Socially Accepted”
...
## [](https://dev.to/_boweii/choosing-a-stack-is-a-social-decision-not-a-technical-one-o60#the-hidden-question-behind-every-stack-choice)The Hidden Question Behind Every Stack Choice
...
## [](https://dev.to/_boweii/choosing-a-stack-is-a-social-decision-not-a-technical-one-o60#this-is-why-stack-debates-never-end)This Is Why Stack Debates Never End
...
## [](https://dev.to/_boweii/choosing-a-stack-is-a-social-decision-not-a-technical-one-o60#why-this-matters-especially-for-developers)Why This Matters (Especially for Developers)
...
## [](https://dev.to/_boweii/choosing-a-stack-is-a-social-decision-not-a-technical-one-o60#the-real-skill-isnt-choosing-the-stack)The Real Skill Isn’t Choosing the Stack
...
## [](https://dev.to/_boweii/choosing-a-stack-is-a-social-decision-not-a-technical-one-o60#final-thought)Final Thought
...
graph TD
    subgraph "Decision Process"
        direction LR
        A[Start: Choose a Tech Stack] --> B{Is there a stack the team already knows well?};
        B -- Yes --> C(Use the familiar stack);
        B -- No --> D{Is there a large talent pool for this stack?};
        D -- Yes --> E(Choose stack that's easy to hire for);
        D -- No --> F{Is the stack popular or backed by a big company?};
        F -- Yes --> G(Choose the "safe" or "modern" stack);
        F -- No --> H(Political debate based on seniority/influence);
    end

    subgraph "Primary Drivers"
        direction TB
        familiarity("Familiarity & Reduced Risk") -.-> C;
        hiring("Hiring & Onboarding") -.-> E;
        trends("Industry Trends & Social Proof") -.-> G;
        politics("Team Politics & Experience") -.-> H;
    end
